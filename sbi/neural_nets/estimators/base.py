...
class MaskedConditionalVectorFieldEstimator(MaskedConditionalEstimator, ABC):
    ...
    def build_unmasked_conditional_vector_field_estimator(
        ...
        # ? This is the only solution if we want to move the wrapper to the utils,
        # ? It looks much more dirty than the previous implementation.
        # ? Should we define the class here?
